      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '24px 16px 48px' }}>
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '13px', color: '#64748b', lineHeight: '1.6' }}>
            ...
            <a href="https://sattutor.pro" style={{ color: '#2563EB', textDecoration: 'none' }}>
              SAT Tutor Pro
            </a>
            , an AI-powered SAT practice app that tracks how{' '}
            <strong>{student_first_name}</strong> gets things wrong — not just what they get wrong
            — to personalize every study session.{' '}
            <a href="https://sattutor.pro" style={{ color: '#2563EB', textDecoration: 'none' }}>
              Learn more at sattutor.pro
            </a>
          </p>
        </div>
